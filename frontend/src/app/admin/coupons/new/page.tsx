      ...
      <form onSubmit={handleSubmit} className="bg-white border p-6 max-w-2xl space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="code" value={form.code} onChange={handleChange} placeholder="e.g. SUMMER30" className="w-full border px-3 py-2 text-sm outline-none font-mono" required />
          </div>
          <div>
        ...
        <div>
          ...
          <textarea name="description" value={form.description} onChange={handleChange} rows={2} className="w-full border px-3 py-2 text-sm outline-none resize-none" placeholder="Optional description" />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input type="number" name="maxDiscountAmount" value={form.maxDiscountAmount} onChange={handleChange} step="0.01" min="0" className="w-full border px-3 py-2 text-sm outline-none" placeholder="For percentage coupons" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            ...
            <input type="number" name="maxUsageCount" value={form.maxUsageCount} onChange={handleChange} min="1" className="w-full border px-3 py-2 text-sm outline-none" placeholder="Unlimited if empty" />
          </div>
          <div>
        ...
        <div className="flex gap-3 pt-4">
          <Button type="submit" loading={loading}>{loading ? 'Creating...' : 'Create Coupon'}</Button>
