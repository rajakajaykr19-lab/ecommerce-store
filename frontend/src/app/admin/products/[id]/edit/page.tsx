...
import { ArrowLeft, Loader2, X, ChevronDown, ChevronRight } from 'lucide-react';
    ...
    <div className="max-w-4xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex gap-3">
          ...
          <Link href={`/admin/products/${id}`}><Button type="button" variant="outline">Cancel</Button></Link>
        </div>
      </form>
    </div>
  );
