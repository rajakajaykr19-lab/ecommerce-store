...
export const seedDatabase = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const mappings: Record<string, string[]> = {
      'shirts': ['fit', 'sleeve-type', 'collar', 'pattern', 'fabric', 'material', 'closure', 'color', 'clothing-size', 'occasion', 'wash-care', 'clothing-length', 'pocket-count'],
      't-shirts': ['fit', 'sleeve-type', 'neck-style', 'pattern', 'fabric', 'material', 'graphic-print', 'color', 'clothing-size', 'occasion', 'wash-care', 'stretchable'],
      'jeans': ['fit', 'waist-rise', 'stretchable', 'pocket-count', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'clothing-length', 'closure'],
      'trousers': ['fit', 'waist-rise', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'closure', 'pleats'],
      'jackets': ['fit', 'sleeve-type', 'collar', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'closure', 'clothing-length'],
      'hoodies': ['fit', 'sleeve-type', 'neck-style', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'graphic-print', 'stretchable'],
      'kurtas': ['fit', 'sleeve-type', 'collar', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'clothing-length', 'closure', 'border'],
      'shorts': ['fit', 'waist-rise', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'closure', 'pocket-count', 'clothing-length'],
      'blazers': ['fit', 'sleeve-type', 'collar', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'closure', 'pocket-count'],
      'sarees': ['fabric', 'material', 'pattern', 'color', 'border', 'blouse-piece', 'length', 'occasion', 'transparency', 'wash-care'],
      'kurtis': ['fit', 'sleeve-type', 'neck-style', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'clothing-length', 'closure'],
      'dresses': ['fit', 'sleeve-type', 'neck-style', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'clothing-length', 'closure', 'waist-rise'],
      'tops': ['fit', 'sleeve-type', 'neck-style', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'graphic-print'],
      'leggings': ['fit', 'waist-rise', 'stretchable', 'fabric', 'material', 'color', 'clothing-size', 'occasion', 'wash-care'],
      'palazzo': ['fit', 'waist-rise', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'closure', 'clothing-length'],
      'skirts': ['fit', 'waist-rise', 'fabric', 'material', 'pattern', 'color', 'clothing-size', 'occasion', 'wash-care', 'pleats', 'clothing-length'],
    };
